...
public class PurchaseRestController {
    ...
    // =========================================================================
    // 7) 판매 목록(관리자) : GET /purchase/json/listSale
    //    (원본처럼 관리자만 허용, map+search 반환)
    // =========================================================================
    @GetMapping("/listSale")
    public Map<String, Object> listSale(HttpSession session,
        ...
        int cp = (currentPage != null ? currentPage : page);
        if (cp <= 0) cp = 1;
        ...
        res.put("map", map);
        res.put("search", search);
        res.put("view", "/purchase/saleListView.jsp");
        return res;
    }
