...
<form id="productForm" name="detailForm" method="post" enctype="multipart/form-data">
...
<!-- 추가: 업데이트 후 상세/리스트 분기 유지를 위해 POST로 같이 보냄 -->
            ...
            <td background="${ctx}/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
			  <c:choose>
			    <c:when test="${isUpdate or isUpdate eq 'true' or param.isUpdate eq 'true'}">
			      <c:url var="manageUrl" value="./listProductEntry">
