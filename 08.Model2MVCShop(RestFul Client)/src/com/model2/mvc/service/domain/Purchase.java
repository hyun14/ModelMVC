...
public class Purchase {
	...
	public String getPaymentOptionLabel() {
	    ...
	    switch (paymentOption) {
	        case "CSH": return "현금";
	        case "CRD": return "카드";
	        default:    return paymentOption;
	    }
	}

	public String getTranStatusLabel() {
	    if (tranCode == null || tranCode.trim().isEmpty()) return "판매중";
	    switch (tranCode) {
	        case "BEF": return "배송전 상태 입니다";
	        case "SHP": return "현재 배송중 상태 입니다";
	        case "DLV": return "현재 배송완료 상태 입니다";
