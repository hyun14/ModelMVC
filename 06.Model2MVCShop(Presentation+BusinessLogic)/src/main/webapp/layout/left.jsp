    ...
    <td valign="top">
      <table border="0" cellspacing="0" cellpadding="0" width="159">
        <c:if test="${not empty vo}">
          <tr>
            <td class="Depth03">
              <a href="${ctx}/getUser.do?userId=${vo.userId}" target="rightFrame">개인정보조회</a>
            </td>
          </tr>
        </c:if>
        <c:if test="${role == 'admin'}">
          <tr>
            <td class="Depth03">
              <a href="${ctx}/listUser.do" target="rightFrame">회원정보조회</a>
            </td>
          </tr>
        </c:if>
        <tr>
    ...
    <tr>
      <td valign="top">
        <table border="0" cellspacing="0" cellpadding="0" width="159">
          ...
          <tr>
            <td class="Depth03">
              <a href="${ctx}/listProduct.do?menu=manage" target="rightFrame">판매상품관리</a>
            </td>
          </tr>
          <tr>
            <td class="DepthEnd">&nbsp;</td>
    ...
    <td valign="top">
      <table border="0" cellspacing="0" cellpadding="0" width="159">
        <c:if test="${not empty vo and role == 'user'}">
          <tr>
            <td class="Depth03">
              <a href="${ctx}/listProductByUser.do?menu=search" target="rightFrame">상 품 검 색</a>
            </td>
          </tr>
          <tr>
            <td class="Depth03">
              <a href="${ctx}/listPurchase.do" target="rightFrame">구매이력조회</a>
            </td>
          </tr>
        </c:if>
        <tr>
