...
<%-- [제출 폼] START --%>
<form id="listForm" name="listForm" method="post" action="${ctx}/listPurchase.do">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	  ...
	  <c:forEach var="p" items="${list}">
	    <tr class="ct_list_pop">
	      <td align="center"><a href="${ctx}/getPurchase.do?tranNo=${p.tranNo}">${p.tranNo}</a></td>
	      <td></td>
	      ...
	      <td align="center">
	        <c:choose>
	          <c:when test="${code eq '3' or code eq 'SHP'}">
	            <a
	              href="${ctx}/updateTranCode.do?tranNo=${p.tranNo}&amp;tranCode=DLV">
	              물건도착
	            </a>
	          </c:when>
	          <c:otherwise>-</c:otherwise>
